...
@section('sidebar')
    ...
    @section('submenu-supplier')
        ...
        <a href="{{ route('supplier.create') }}"
            class="list-group-item list-group-item-action ps-4 
            {{ request()->is('supplier/create') ? 'active' : '' }}">
            Tambah Supplier
        </a>

        <a href="{{ url('/supplier/search') }}"
            class="list-group-item list-group-item-action ps-4 
            {{ request()->is('supplier/search') ? 'active' : '' }}">
            Cari Supplier
        </a>
    @endsection
@endsection
...
<div class="container-fluid">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-3"><strong>ID Supplier</strong></div>
                <div class="col-md-9">{{ $supplier->id }}</div>
            </div>

            <div class="row mb-3">
                <div class="col-md-3"><strong>Nama Supplier</strong></div>
